...
//		getCF().addMoreCharEntries();
    ...
    public static final String CREATE_CHARACTER_TABLE_STMT = 
    		...
    		+ "CONSTRAINT fk_CharInfo_Player FOREIGN KEY (Player_ID) REFERENCES Player(P_Login) ON DELETE CASCADE,"
    ...
    */
    ...
    public void addMoreCharEntries() throws SQLException
	{
	      String[][] characterEntries = new String[5][7];
	      characterEntries[0][0] = "Maddi"; characterEntries[0][1] = "60"; characterEntries[0][2] ="70"; characterEntries[0][3] = "70"; characterEntries[0][4] = "53"; characterEntries[0][5] = "456"; characterEntries[0][6] = "123456";
	      characterEntries[1][0] = "Michaela"; characterEntries[1][1] = "46"; characterEntries[1][2] = "4"; characterEntries[1][3] = "70"; characterEntries[1][4] = "30"; characterEntries[1][5] = "234"; characterEntries[1][6] = "654321";
	      characterEntries[2][0] = "Steve"; characterEntries[2][1] = "60"; characterEntries[2][2] = "4"; characterEntries[2][3] = "66"; characterEntries[2][4] = "34"; characterEntries[2][5] = "345"; characterEntries[2][6] = "785968";
	      characterEntries[3][0] = "Jordi"; characterEntries[3][1] = "70"; characterEntries[3][2] = "5"; characterEntries[3][3] = "27"; characterEntries[3][4] = "24"; characterEntries[3][5] = "567"; characterEntries[3][6] = "285856";
	      characterEntries[4][0] = "Donkey Kong"; characterEntries[4][1] = "60"; characterEntries[4][2] = "10"; characterEntries[4][3] = "10"; characterEntries[4][4] = "10"; characterEntries[4][5] = "234"; characterEntries[4][6] = "456987";
	      ...
	      System.out.println("addMoreCharEntries() added 5 entries to CharInfo.");
	}
